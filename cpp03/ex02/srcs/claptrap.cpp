...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/08/09 14:29:21 by ppiques           #+#    #+#             */
/*   Updated: 2022/08/09 14:29:21 by ppiques          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ClapTrap::attack(std::string const &target)
{
	...
	if (this->_ad == 1 || this->_ad <= 0 )
		std::cout << this->_name << " inflicts " << this->_ad << " point of damage to " << target << " !" << std::endl;
	else
		std::cout << this->_name << " inflicts " << this->_ad << " points of damage to " << target << " !" << std::endl;
	this->_ep -= -1;
}
...
void	ClapTrap::takeDamage(unsigned int amount)
{
	...
	if (amount == 1 || amount <= 0)
		std::cout << this->_name << " receives " << amount << " point of damage !" << std::endl;
	else
...
void	ClapTrap::beRepaired(unsigned int amount)
{
	...
	if (amount <= 0)
	{
		std::cout << "Error : " << this->_name << " cannot heal for 0 hitpoints." << std::endl;
		return ;
	}
	if (this->_ep <= 0)
	{
	...
	if (amount == 1)
	{
		std::cout << this->_name << " heals for " << amount << " hitpoint !" << std::endl;
		std::cout << this->_name << " has " << this->_hp << " hitpoints left." << std::endl;
		return ;
	}
	else 
